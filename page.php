            ...
            <div class="col-lg-8 col-xl-7 col-xxl-6">
                <div class="my-5 text-center text-xl-start">
                    <?php if (pods_field_display('heading')) : ?><h1 class="display-5 fw-bolder text-white mb-2"><?php echo pods_field_display('heading') ?></h1> <?php endif; ?>
                        ...
                        <?php if (pods_field_display('button_1_text')) : ?> <a class="btn btn-primary btn-lg px-4 me-sm-3" href="<?php echo pods_field_display('button_1_url') ?>"><?php echo pods_field_display('button_1_text') ?></a></p><?php endif; ?>
                        <?php if (pods_field_display('button_2_text')) : ?> <a class="btn btn-outline-light btn-lg px-4" href="<?php echo pods_field_display('button_2_url') ?>"><?php echo pods_field_display('button_2_text') ?></a></p><?php endif; ?>
                        </div>
                </div>
                </div>
