...
// add css and js
add_action('wp_enqueue_scripts', 'fs_mb_scripts');
function fs_mb_scripts() {
...
add_image_size('mb-portfolio-hero'	, 1300, 700, true);
add_image_size('mb-portfolio-hero-medium'	, 600, 400, true);